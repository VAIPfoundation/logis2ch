...
@Slf4j
public class ShippingFinishHandler extends AbstractShippingReceiver {
	
	public ShippingFinishHandler(ShippingPlanContext context) {
		super(context, IDriverFinishJobEvent.class);
	}
