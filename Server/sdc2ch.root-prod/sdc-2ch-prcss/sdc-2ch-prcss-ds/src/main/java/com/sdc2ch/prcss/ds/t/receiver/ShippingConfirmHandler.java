...
import com.sdc2ch.service.event.IDriverAllocateConfirmEvent;
import com.sdc2ch.service.event.IMobileEvent;

import lombok.extern.slf4j.Slf4j;

@Slf4j
public class ShippingConfirmHandler extends AbstractShippingReceiver {
	
	public ShippingConfirmHandler(ShippingPlanContext context) {
		super(context, IDriverAllocateConfirmEvent.class);
	}
