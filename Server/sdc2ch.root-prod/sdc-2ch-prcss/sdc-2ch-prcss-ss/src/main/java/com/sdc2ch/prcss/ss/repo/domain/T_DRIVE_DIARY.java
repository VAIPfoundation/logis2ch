...
@Setter
@Entity
@Table(name="T_DRIVE_DIARY", indexes = @Index(name = "T_DRIVE_DIARY_01", columnList = "DLVY_DE,ROUTE_NO,DLVY_LC_CD,STTUS_CD,EVENT_CD"))
public class T_DRIVE_DIARY extends T_ID implements DriveDiaryIO2 {
