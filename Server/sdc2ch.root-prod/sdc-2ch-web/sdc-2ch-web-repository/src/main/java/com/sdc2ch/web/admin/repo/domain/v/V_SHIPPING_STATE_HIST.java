...
@Setter
@ToString
public class V_SHIPPING_STATE_HIST {
	...
	@Column(name = "DLVY_CNT", updatable = false)
	private Integer dlvyCnt;
	@Column(name = "EMPTYBOX_DLVY_CNT", updatable = false)
	private Integer emptyboxDlvyCnt;
	@Column(name = "ROUTE_CNT", updatable = false)
	private Integer routeCnt;
	@Column(name = "DAY_CNT", updatable = false)
