...
@Entity
@Table(name = "T_ROUTE_PATH_MATRIX3_1008")
@Getter
@Setter
public class T_ROUTE_PATH_MATRIX2 extends T_ID {
	...
	public String toString() {
		return "T_ROUTE_PATH_MATRIX2 [startPos=" + startPos + ", startLat=" + startLat + ", startLng=" + startLng
				+ ", endPos=" + endPos + ", endLat=" + endLat + ", endLng=" + endLng + ", tmsDistance=" + tmsDistance
				+ ", newDistance=" + newDistance + ", tmsTollCost=" + tmsTollCost + ", newTollCost=" + newTollCost
				+ ", dlvyDe=" + dlvyDe + ", routeNo=" + routeNo + ", vrn=" + vrn + "]";
	}
