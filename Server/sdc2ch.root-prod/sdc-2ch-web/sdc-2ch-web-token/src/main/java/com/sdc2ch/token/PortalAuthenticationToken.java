...
public class PortalAuthenticationToken extends AbstractAuthenticationToken implements I2CHAuthorization {
    private static final long serialVersionUID = 2877954820905567501L;

    private RawAccessJwtToken rawAccessToken;
    private I2CHUserContext userContext;

    public PortalAuthenticationToken(RawAccessJwtToken unsafeToken) {
        super(null);
        this.rawAccessToken = unsafeToken;
        this.setAuthenticated(false);
    }

    public PortalAuthenticationToken(I2CHUserContext userContext, Collection<? extends GrantedAuthority> authorities) {
        super(authorities);
