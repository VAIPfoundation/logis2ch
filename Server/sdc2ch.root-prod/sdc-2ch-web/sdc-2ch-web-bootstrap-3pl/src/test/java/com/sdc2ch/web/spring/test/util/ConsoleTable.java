...
public abstract class ConsoleTable {
	...
	public ConsoleTable(int numCol, int gap, String border, int align, boolean sort) {
	...
	public ConsoleTable(int numCol, int gap, String border, int align) {
		this(numCol, gap, border, align, DEFAULT_SORT);
	}

	
	public ConsoleTable(int numCol, int gap, String border) {
		this(numCol, gap, border, LEFT);
	}

	
	public ConsoleTable(int numCol, int gap) {
