...
public class RoutePathInfoTest_dlvy {
	...
	private T_ROUTE_PATH_MATRIX execute(Point point1, RouteInfo r, HashMap<String, Object> paramMap) {
		try {
			...
			FileUtils.write(new File("new_" + point1.getName() + "_" +  fileName), json + "\r\n", Charset.forName("UTF-8"), true);
	...
	public static void main(String[] args) {
		RoutePathInfoTest_dlvy test3 = new RoutePathInfoTest_dlvy();
