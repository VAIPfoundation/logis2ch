...
public class TmsSettleCost {
	...
	public String toString() {
		return "TmsSettleCost [kmPerLiter=" + kmPerLiter + ", contractPrice=" + contractPrice + ", tollCost=" + tollCost
				+ ", distance=" + distance + ", carOilQty=" + carOilQty + ", frezingOilQty=" + frezingOilQty
