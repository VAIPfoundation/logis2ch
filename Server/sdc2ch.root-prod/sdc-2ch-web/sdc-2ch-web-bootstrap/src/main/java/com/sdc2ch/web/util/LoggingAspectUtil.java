...
class LoggingAspectUtil {
	...
	private List<String> ignoreClasses = Arrays.asList(
			...
			"com.sdc2ch.tms.service.impl.TmsDriverServiceImpl",
			"com.sdc2ch.tms.service.impl.TmsUserServiceImpl",
			"com.sdc2ch.service.common.impl.UserDetailServiceImpl",
			"com.sdc2ch.tms.service.impl.TmsPlanServiceImpl",
			"com.sdc2ch.service.common.impl.IOTSensorServiceImpl",
			"com.sdc2ch.legacy.aiv.impl.IotServiceImpl"
			);
